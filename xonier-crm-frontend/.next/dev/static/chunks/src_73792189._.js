...
const page = ()=>{
    ...
    const handleBulkUpload = async ()=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$lead$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].bulkCreate();
            if (result.status === 200) {
...
_s(page, "Eyzatu/lTFZofKVsSsX5h/7IfyQ=");
...
//# sourceMappingURL=src_73792189._.js.map