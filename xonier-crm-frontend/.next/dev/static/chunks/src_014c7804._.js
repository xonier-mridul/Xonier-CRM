...
const page = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setErr("");
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$lead$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create(formData);
            if (result.status === 201) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${formData.fullName} lead created successfully`);
                setFormData({
                    fullName: "",
                    email: "",
                    phone: "",
...
_s(page, "l27T8FpPXp5o5sEZJmnRdfK4d30=", false, function() {
    return [
