...
"[project]/src/app/(dashboard)/roles/update/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const UpdateRolePage = ()=>{
    ...
    const [permissionData, setPermissionData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const getRoleData = async (id)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RoleService"].getRoleById(id);
            if (result.status === 200) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RoleService"].update(id, formData);
            if (result.status === 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Role updated successfully");
...
_s(UpdateRolePage, "FNqbEdvJLrzIVoCKJzPgFQo+XtE=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "UpdateRolePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_6d7a145c._.js.map