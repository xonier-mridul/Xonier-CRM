...
const page = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setErr(null);
        try {
            let result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].login(formData);
            if (result.status === 200) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(result.data.message);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ce072bd._.js.map