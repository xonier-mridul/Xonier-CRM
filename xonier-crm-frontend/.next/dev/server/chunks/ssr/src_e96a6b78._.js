...
const Page = ()=>{
    ...
    const handlePinNote = async (id)=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$notes$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].ChangePinnedStatus(id);
            if (result.status === 200) {
...
//# sourceMappingURL=src_e96a6b78._.js.map