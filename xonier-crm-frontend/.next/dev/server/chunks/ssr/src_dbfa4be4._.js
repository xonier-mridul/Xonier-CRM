...
"[project]/src/app/(dashboard)/enquiry/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const page = ()=>{
    ...
    const getEnquiryData = async ()=>{
        ...
        try {
            ...
            if (auth.isAdmin) {
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$enquiry$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EnquiryService"].getAll({
                    page: currentPage,
                    limit: pageLimit
                });
                ...
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$enquiry$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EnquiryService"].getAllByCreator(currentPage, pageLimit);
                if (result.status === 200) {
                    let data = result.data.data;
                    setEnquiryData(data.data);
                    setCurrentPage(data.page);
    ...
    const handleDelete = async (id)=>{
        try {
            ...
            if (confirm) {
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$enquiry$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EnquiryService"].delete(id);
                if (result.status === 200) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Enquiry deleted successfully");
...
//# sourceMappingURL=src_dbfa4be4._.js.map