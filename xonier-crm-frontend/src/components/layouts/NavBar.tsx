                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-2/3 flex flex-col gap-2">
                      <h3 className="text-slate-900 dark:text-white text-lg capitalize">
                        {auth?.user?.firstName} {auth?.user?.lastName}
                      </h3>
                      <span>{}</span>
                    </div>
                  ...
                  <ul className="flex flex-col gap-5">
                    <li>
                      ...
                      >
                        {" "}
                        <span className="h-11 w-11 rounded-md bg-blue-800/10 dark:bg-slate-100 dark:text-slate-900 flex items-center justify-center overflow-hidden">
                          {" "}
                          <FiUser className="text-2xl group-hover:scale-110 transition-all duration-300" />{" "}
                        </span>{" "}
                        <div className="flex flex-col">
                          <h4 className="text-slate-900 dark:text-white font-semibold group-hover:text-blue-600">
                            {" "}
                            My Profile
                          </h4>
                    ...
                    <li>
                      ...
                      >
                        <span className="h-11 w-11 rounded-md bg-blue-800/10 dark:bg-slate-100 dark:text-slate-900 flex items-center justify-center overflow-hidden">
                          {" "}
                          <FaRegBuilding className="text-xl group-hover:scale-110 transition-all duration-300" />{" "}
                        </span>
                        <div className="flex">
                          <h4 className="text-slate-900 dark:text-white font-semibold group-hover:text-blue-600">
                            {" "}
                            {isAdmin ? "Companies" : "My Company"}
                          </h4>
                        </div>
                      </Link>
                    </li>
