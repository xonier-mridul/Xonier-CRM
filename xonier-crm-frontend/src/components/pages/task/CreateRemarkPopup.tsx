      ...
      <div className="bg-white dark:bg-gray-800 w-full max-w-lg rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-gray-900 dark:text-white">Add Remark</h2>
              <p className="text-xs text-gray-400 dark:text-gray-500">Leave a note on this task</p>
            </div>
          </div>
          <button
            onClick={onCancel}
        ...
        {task && (
          <div className="mx-6 mt-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-100 dark:border-gray-700">
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-400 dark:text-gray-500 mb-2">Task Reference</p>
        ...
        <form onSubmit={handleAddRemark} className="px-6 py-4 flex flex-col gap-4">
          <div>
            ...
            />
            <p className="text-[10px] text-gray-400 mt-1 text-right">{remarkPayload.content.length} characters</p>
          </div>
