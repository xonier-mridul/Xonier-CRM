...
const EmailClientPreview = ({
  ...
  return (
    <div className="flex flex-col rounded-2xl border border-slate-200 dark:border-gray-600 overflow-hidden shadow-md bg-white dark:bg-gray-800">
      ...
      {/* ── Window chrome bar ── */}
      <div
        className="flex items-center gap-2 px-4 py-3 border-b dark:bg-gray-900 border-slate-200 dark:border-gray-600"
...
export default function Page() {
  ...
  return (
    <div className="p-8 min-h-screen dark:bg-gray-900 rounded-2xl" >
