            ...
            <div className="flex items-center gap-6 flex-wrap">
              ...
              <div className="relative" ref={pickerRef}>
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border border-slate-900/10 text-sm font-semibold transition-all duration-200 cursor-pointer ${showColumnPicker
