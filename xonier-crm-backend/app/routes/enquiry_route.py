...
Depends(dependencies.company_context), Depends(dependencies.permissions(["enquiry:read"]))])
...
Depends(dependencies.company_context),Depends(dependencies.permissions(["enquiry:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["enquiry:update"]))])
