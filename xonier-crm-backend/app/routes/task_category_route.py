...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskCategory:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskCategory:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskCategory:update"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskCategory:delete"]))])
