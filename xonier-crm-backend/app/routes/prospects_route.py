...
Depends(dependencies.company_context), Depends(dependencies.permissions(["prospect:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["enquiry:assign"]))])
