...
Depends(dependencies.company_context), Depends(dependencies.permissions(["task:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["remark:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["remark:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["task:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["task:update"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["task:statusChange"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["task:assign"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["task:delete"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["remark:delete"]))])
