...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["task_timer:start"]))])
...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["task_timer:pause"]))])
...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["task_timer:resume"]))])
...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["task_timer:stop"]))])
...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["task_timer:read"]))])
