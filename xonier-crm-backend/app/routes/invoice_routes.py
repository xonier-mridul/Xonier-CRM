...
Depends(dependencies.company_context), Depends(dependencies.permissions(["invoice:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["invoice:download"]))])
