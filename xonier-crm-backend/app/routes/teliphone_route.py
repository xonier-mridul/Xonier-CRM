...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TELECOM)), Depends(dependencies.permissions(["telephone:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TELECOM)), Depends(dependencies.permissions(["telephone:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TELECOM)), Depends(dependencies.permissions(["telephone:update"]))])
