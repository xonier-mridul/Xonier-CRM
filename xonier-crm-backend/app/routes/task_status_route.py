...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskStatus:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskStatus:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskStatus:update"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["taskStatus:delete"]))])
