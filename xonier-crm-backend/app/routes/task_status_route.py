...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:read"]))])
async def get_all_task_statuses(request: Request):
    return await controller.get_all_task_statuses(request)
 
 
@router.get("/by-category/{category_id}", status_code=200, dependencies=[Depends(dependencies.authorized), Depends(dependencies.company_active),
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:read"]))])
...
@router.get("/{status_id}", status_code=200, dependencies=[Depends(dependencies.authorized), Depends(dependencies.company_active),
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:read"]))])
...
@router.put("/update/{status_id}", status_code=200, dependencies=[Depends(dependencies.authorized), Depends(dependencies.company_active),
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:update"]))])
...
@router.delete("/delete/{status_id}", status_code=200, dependencies=[Depends(dependencies.authorized), Depends(dependencies.company_active),
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:delete"]))])
async def delete_task_status(request: Request, status_id: str):
    return await controller.delete_task_status(request, status_id)


@router.get("/deleted/all-deleted", status_code=200, dependencies=[Depends(dependencies.authorized), Depends(dependencies.company_active),
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:read"]))])
async def get_all_deleted_statuses(request: Request):
    return await controller.get_all_deleted_statuses(request)
 
 
@router.delete("/permanent-delete/{status_id}", status_code=200, dependencies=[Depends(dependencies.authorized), Depends(dependencies.company_active),
Depends(dependencies.company_context), Depends(dependencies.feature_access(FEATURE.TASK)), Depends(dependencies.permissions(["taskStatus:delete"]))])
