...
Depends(dependencies.company_context), Depends(dependencies.permissions(["quote:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["quote:update"]))])
