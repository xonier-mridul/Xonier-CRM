...
Depends(dependencies.company_context), Depends(dependencies.permissions(["team:create"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["team:read"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["team:update"]))])
...
Depends(dependencies.company_context), Depends(dependencies.permissions(["team:delete"]))])
